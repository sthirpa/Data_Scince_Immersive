...
st.subheader("Please Upload images related to this class_names...")
...
if st.button("Predict"):
    ...
    string = "Image mostly looks like: " + class_names[np.argmax(predictions)]
    st.success(string)
# from: https://github.com/Sarthak-1408
