...
Rubric (14 points total):
+ 1 : for importing libraries
+ 1 : for reading in the data
+ 1 : for setting name column as the index
+ 1 : for converting TARGET_5Yrs column to 0/1
...
+ 1 : for including the name as the index in predictions DataFrame (full credit will also be given for including the names as another column)
...
BONUS - + 3 : for submitting a python script rather than a Jupyter notebook
